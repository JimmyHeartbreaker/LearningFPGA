...
HD_PWD='/media/jimmyheartbreaker/UDATA/_REPOS/LearningFPGA/And_Gate/And_Date.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log And_Gate_TB.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source And_Gate_TB.tcl -notrace
