...
HD_PWD='/media/jimmyheartbreaker/UDATA/_REPOS/LearningFPGA/And_Gate/And_Date.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log And_Gate_TB.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source And_Gate_TB.tcl
